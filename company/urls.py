...
urlpatterns = [
    path('api/company-options/', views.get_company_options, name='get_company_options'),
    path('api/company-options-draft/', views.get_company_options_for_draft, name='get_company_options_for_draft'),
    path('api/supplier-products/', views.get_supplier_products, name='get_supplier_products'),
